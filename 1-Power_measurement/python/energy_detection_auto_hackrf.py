...
class energy_detection(gr.top_block, Qt.QWidget):
    ...
    def null_sink(self):
        ...
        self.disconnect((self.blocks_nlog10_ff_0, 0), (self.blocks_file_sink_0, 0))
        self.blocks_file_sink_0 = blocks.file_sink(
            gr.sizeof_float * 1, "/dev/null", False
        )
        self.blocks_file_sink_0.set_unbuffered(False)
        self.connect((self.blocks_nlog10_ff_0, 0), (self.blocks_file_sink_0, 0))
        gr.top_block.start(self)

    def change_sink(self, freq):
        raw_file = "raw_saves/" + str(freq)
        gr.top_block.stop(self)
        self.disconnect((self.blocks_nlog10_ff_0, 0), (self.blocks_file_sink_0, 0))
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float * 1, raw_file, False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.connect((self.blocks_nlog10_ff_0, 0), (self.blocks_file_sink_0, 0))
        gr.top_block.start(self)
